...
namespace FFX {
	class FileFilter {
	public:
		virtual bool Accept(const FileInfo& file) const = 0;
	};
	...
	class FFXUTILS_EXPORT AndFileFilter : public ComposeFileFilter
	{
	public:
		AndFileFilter(FileFilterPtr left, FileFilterPtr right)
			: ComposeFileFilter(left, right) {}
	public:
		virtual bool Accept(const FileInfo& file) const override;
	};

	class FFXUTILS_EXPORT OrFileFilter : public ComposeFileFilter
	{
	public:
	...
	class FFXUTILS_EXPORT NotFileFilter : public FileFilter
	{
	public:
	...
	class FFXUTILS_EXPORT IsFileFilter : public FileFilter
	{
	public:
		virtual bool Accept(const FileInfo& file) const override;
	};

	class FFXUTILS_EXPORT IsDirFilter : public FileFilter
	{
	public:
		virtual bool Accept(const FileInfo& file) const override;
	};

	class FFXUTILS_EXPORT RegExpFileFilter : public FileFilter
	{
	public:
